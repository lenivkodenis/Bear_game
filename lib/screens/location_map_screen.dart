      ...
      builder: (context, constraints) {
        ...
        if (_lastViewportSize != viewportSize || _lastMapSize != mapSize) {
          ...
          WidgetsBinding.instance.addPostFrameCallback((_) {
            if (mounted) _restoreLogicalCenter(viewportSize, mapSize);
          });
        }
