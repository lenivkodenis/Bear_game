class LevelBackgroundAssets {
  ...
  static const Map<int, String> auditedBackgroundsWithBakedInBearByLevelId =
      <int, String>{
  ...
  static const Map<int, String> cleanBackgroundsByLevelId = <int, String>{};

  static String forLevelId(int levelId) {
    return cleanBackgroundsByLevelId[levelId] ?? fallbackAssetPath;
  }
