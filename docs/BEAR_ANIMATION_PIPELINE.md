...
```text
assets/images/characters/bear_cub/animations/walk_normalized/walk_01_normalized.png
assets/images/characters/bear_cub/animations/walk_normalized/walk_02_normalized.png
assets/images/characters/bear_cub/animations/walk_normalized/walk_03_normalized.png
assets/images/characters/bear_cub/animations/walk_normalized/walk_04_normalized.png
assets/images/characters/bear_cub/animations/walk_normalized/walk_05_normalized.png
assets/images/characters/bear_cub/animations/walk_normalized/walk_06_normalized.png
```
...
The original generated walk PNGs had stable canvas size and nearly stable center x, but their visible alpha bottoms differed by up to 12 px. The normalized copies keep the same frame order and image scale, but shift each frame inside the same canvas so the visible bottom alpha line is consistent. Diagnostics are generated by:

```text
.venv-tools/bin/python tools/diagnose_bear_walk_cycle.py
```

Diagnostic previews:

```text
docs/bear_walk_cycle_diagnostics.png
docs/bear_walk_cycle_normalization_preview.png
```
